...
#'
#' Get a subset of basis functions produced by \code{getBasisFunctions()},
#' subsetting based on distance from center and the number of pixels in each
#' basis function.
#'
#'
...
#'   squares, and \code{"sum"} for the sum of pixel values.
#'
