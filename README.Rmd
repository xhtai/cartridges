...
* Code speed-ups are possible, especially for steps 4 and 5, which were optimized for MATLAB. In particular, inpaint_nans was translated line by line from [published code by John D'Errico](https://www.mathworks.com/matlabcentral/fileexchange/4551-inpaint-nans), and is extremely slow in R.
* Test on more data.
